...
var Compress, CompressImg, ConvertTemplate, compress, convert, formidable, fs, mkdirp, path, util, uuid;
...
Compress = (function() {
  ...
  Compress.prototype.post = function(req, res) {
    var fields, form, uuidRandon;
    uuidRandon = uuid.v1();
    mkdirp("uploads/" + uuidRandon + "/", function(err) {
      if (err) {
        console.error(err);
      } else {
        console.log('Done!');
    ...
    form.on('fileBegin', function(name, file) {
      return file.path = ("./uploads/" + uuidRandon + "/") + file.name;
    });
